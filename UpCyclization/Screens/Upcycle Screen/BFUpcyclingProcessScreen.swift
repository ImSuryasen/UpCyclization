...
struct BFEmbedView : UIViewRepresentable {
...
//                .frame(width: 300,height: 50, alignment: .leading)
            ...
            HStack{
                VStack{
                    BFEmbedView(videoID: "ComKxjdPfjw")
...
struct UpcyclingProcessScreen_Previews: PreviewProvider {
